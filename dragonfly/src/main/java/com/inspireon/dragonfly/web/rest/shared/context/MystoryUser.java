package com.inspireon.dragonfly.web.rest.shared.context;
...
public class MystoryUser implements UserDetails {
    ...
    public MystoryUser(String userId, String username, String password, 
    					String role, List<MystoryAuthority> authorities){
    	  this.userId = userId;
	...
	public String toString() {
		return "DragonFlyUser [username=" + username + ", password=" + password
