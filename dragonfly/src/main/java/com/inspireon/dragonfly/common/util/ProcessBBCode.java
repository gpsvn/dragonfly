...
//    						+ "[i][b]hghgfhgfjhgj [/b][/i][s][sub][u][i][b]jhgjhg[/b][/i][/u][/sub][u][i][b]jhkjhkhgfh[/b][/i][/u]hghgf[/s]hgfhgfhg[size=7]hgfhgfhgfjhgkj:O8-):alien:[/size]\n"));
    ...
    public static void main(String[] args) {
		System.out.println(new ProcessBBCode().preparePostText("[size=16.799999237060547]1. "
				+ "Harry trá»Ÿ thÃ nh Tháº§n sÃ¡ng cá»§a Bá»™ PhÃ¡p thuáº­t, vÃ  sau Ä‘Ã³ Ä‘Æ°á»£c chá»‰ Ä‘á»‹nh lÃ m Tháº§n sÃ¡ng trÆ°á»Ÿng. Cáº­u thÆ°á»�ng Ä‘áº¿n trÆ°á»�ng Hogwarts Ä‘á»ƒ giáº£ng vá»� mÃ´n PhÃ²ng chá»‘ng Nghá»‡ thuáº­t Háº¯c Ã¡m. Harry sá»Ÿ há»¯u chiáº¿c xe mÃ´tÃ´ cá»§a Sirius, nhá»� Arthur Weasley sá»­a dÃ¹m cáº­u. VÃ¬ máº£nh linh há»“n cá»§a Voldermort trong cÆ¡ thá»ƒ cáº­u Ä‘Ã£ bá»‹ phÃ¡ há»§y, Harry vÃ¬ tháº¿ Ä‘Ã£ khÃ´ng cÃ²n cÃ³ thá»ƒ nÃ³i Ä‘Æ°á»£c XÃ  ngá»¯.[/size]"));
	}
